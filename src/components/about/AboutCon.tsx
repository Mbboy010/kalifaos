  ...
  return (
    <div className={`min-h-screen`}>
      <div className="max-w-6xl mx-auto px-4 py-16">
        {/* Logo Section - Add your logo image here */}
        <div className="flex justify-center mb-12">
          <div style={{backgroundColor: isColor ? "#d7d7d719" : "#72727236"}}   className={`p-4 rounded-xl shadow-lg`}>
            ...
            <div className="w-40 h-40 flex items-center justify-center bg-blue-100 rounded-lg">
              ...
              <img src={require("../../assist/Kalifa logo.jpg")} alt="Kalifa OS Logo" className="w-full h-full object-contain" />
        ...
        {/* Contact Information */}
        <div style={{backgroundColor: isColor ? "#d7d7d719" : "#72727236"}}   className={`rounded-xl p-8  shadow-md`}>
