  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl  mt-12 font-extrabold tracking-tight sm:text-5xl lg:text-6xl">Contact Us</h1>
        <p className="mt-6 text-xl max-w-3xl mx-auto">
          Get in touch with Kalifa OS for support or inquiries. Send us a message, call, or email to learn more about our device unlocking services.
        </p>
      </div>
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              <Link href="/terms" className="inline-flex items-center px-4 py-2 text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow-sm">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full mt-1 p-2 rounded-md border border-gray-300 dark:border-gray-700"
                />
              </div>
              ...
              <div>
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md shadow-sm disabled:opacity-50"
                >
                  {loading ? (
                    'Sending...'
                  ) : (
