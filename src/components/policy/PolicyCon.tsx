...
import { Shield, Lock, Database, User, Server, Mail, EyeOff } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="text-center mb-12">
        <div className={`inline-flex mt-12 mb-4  items-center justify-center p-4 rounded-full ${iconBg}`}>
        ...
        {[
          {
            ...
            content: (
              <p>
                At Kalifa OS, we respect your privacy and are committed to protecting your personal data. This policy
          ...
          },
          {
            ...
            content: (
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  <strong>Cookies:</strong> For analytics and functionality
                </li>
              </ul>
            ),
          },
          ...
          },
          {
            ...
            content: (
              <p>
                ...
                <a href="mailto:support@kalifaos.com" className="text-blue-600 hover:underline">
