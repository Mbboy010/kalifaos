// app/frp-tools-apk-download/page.tsx
'use client';

import { Smartphone, Shield, Unlock, Zap, AlertTriangle, Check } from 'lucide-react';
    ...
    <div className="min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <div
            className={`inline-flex items-center mt-10 justify-center p-4 rounded-full ${
              isColor ? 'bg-[#b9d4ff40]' : 'bg-[#b9d4ff6c]'
            }`}
          >
            <Smartphone className="w-10 h-10 text-blue-600" />
          </div>
          <h1 className="text-4xl md:text-5xl mt-7 font-bold mb-4">Mobile Device Services</h1>
          <p className="text-lg">
        ...
        <div
          ...
          className="p-6 rounded-xl mb-12 border border-gray-300 dark:border-gray-700"
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p>
                Our services are intended for legal use only, such as regaining access to your own devices. We do not
                support or condone bypassing security measures on devices you do not own.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { name: 'Pro', price: 'N13,000', desc: 'Multiple devices', features: ['3 Unlocks', 'Priority Support'] },
                {
                  name: 'Enterprise',
                  price: 'N49,000',
                  desc: 'Unlimited unlocks',
                  features: ['Bulk IMEI', 'VIP Support'],
                },
              ].map((plan, index) => (
                <div
                  key={index}
                  className={`border rounded-xl p-6 ${
                    index === 1 ? 'border-blue-600 shadow-lg' : 'border-gray-200 dark:border-gray-700 shadow-lg'
                  }`}
                >
