      ...
      {openMenuId && (
        ...
        >
          <div
            ...
            className="w-full max-w-md bg-white dark:bg-gray-900 rounded-t-2xl p-4 animate-slide-up"
          >
            ...
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-3 text-sm rounded hover:bg-gray-100 dark:hover:bg-gray-800"
            >
